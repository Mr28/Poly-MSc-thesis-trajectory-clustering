...
trajList, trajectories, nTraj = DatabaseSection(nSample=None, dataName=dataName, resetDatabase=False, pickleInDatabase=False, pickleInAllTrajectories=False, maxTrajLength=1800, plot=True)
distMatrices = DistMatricesSection(trajList=trajList, trajectories=trajectories, nTraj=nTraj, dataName=dataName,
                            similarityMeasure=[['GuLcss',[1, 2, 3, 5, 7, 10]], ['GuDtw',[-1]], ['GuPf',[0.01, 0.05, 0.1, 0.2, 0.3, 0.5]],
                                                # ['Lcss',[1, 2, 3, 5, 7, 10]], ['Dtw', [-1]],
                                                ['Hausdorf', [-1]], ['Edr', [1, 2, 3, 5, 7, 10]], ['Sspd', [-1]],
                                                # ['Frechet', [-1]]
                                                ],
...
nClusOriginSet, nClusDestSet , threshold= [10], [7], 10
